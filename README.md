...
| [`sx`](https://github.com/charliek/shed) | ◷ pending first release | RC session porcelain — start, list, watch, attach and kill agent sessions locally, on native machines over SSH, or inside a shed. Replaces the retired `shed-machine-rc` |
